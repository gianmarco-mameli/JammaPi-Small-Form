...
#   fi
# git clone https://github.com/gianmarco-mameli/JammaPi-Small-Form.git
...
##install jammapi overlay
	...
	sudo cp -f vga666.dtbo /boot/overlays/.
	# sudo rm /boot/dt-blob.bin
	sudo cp -f dt-blob.bin /boot/.
	# sudo rm /etc/asound.conf
	sudo cp -f script/asound.conf /etc/.
	sleep 2
